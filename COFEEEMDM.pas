...
procedure TdmCOFEEEM.CargarTipos;
begin
...
procedure TdmCOFEEEM.CrearINI(pAnio, pMes: Integer; pFiltrar: Boolean; pCDirINI,
  pCDirXML: string);
var
  Ini: TIniFile;
  INIFileName: String;
...
procedure TdmCOFEEEM.CrearINI_11(pAnio, pMes: Integer; pFiltrar: Boolean; pCDirINI,
  pCDirXML: string);
var
  Ini: TIniFile;
  INIFileName: String;
...
procedure TdmCOFEEEM.DataModuleCreate(Sender: TObject);
begin
  CargarTipos;
end;
