...
type
  TdmIVEM = class(TDataModule)
    ...
    adoqryNominaC1GD: TFloatField;
    adoqryNominaC1PL: TFloatField;
    adoqryNominaC1PS: TFloatField;
    ...
    adoqryNomina12C1GD: TFloatField;
    adoqryNomina12C1PL: TFloatField;
    adoqryNomina12C1PS: TFloatField;
    ...
    adoqryNomina12C278: TFloatField;
...
procedure TdmIVEM.CrearINI(pAnio, pMes: Integer; pFiltrar: Boolean; pCDirINI,
  pCDirXML: string);
var
  Ini: TIniFile;
  INIFileName: String;
...
procedure TdmIVEM.CrearINI_11(pAnio, pMes: Integer; pFiltrar: Boolean; pCDirINI,
  pCDirXML: string);
var
  Ini: TIniFile;
  INIFileName: String;
...
procedure TdmIVEM.DataModuleCreate(Sender: TObject);
begin
  CargarTipos;
end;
