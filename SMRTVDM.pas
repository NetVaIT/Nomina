...
//        Ini.WriteString('nomReceptor', 'CuentaBancaria', adoqryNomina12nomEmisorCuentaBancaria.AsString);
        Ini.WriteString('nomReceptor', 'SalarioBaseCotApor', adoqryNomina12nomReceptorSalarioBaseCotApor.AsString);
        Ini.WriteString('nomReceptor', 'SalarioDiarioIntegrado', adoqryNomina12nomReceptorSalarioDiarioIntegrado.AsString);
