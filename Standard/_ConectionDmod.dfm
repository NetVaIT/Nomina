object _dmConection: T_dmConection
  ...
  object ADOConnection: TADOConnection
    ConnectionString = 
      ...
      ';User ID=sa;Initial Catalog=IntervaRH_Mig;Data Source=NAS1\COMPA' +
      'C;Use Procedure for Prepare=1;Auto Translate=True;Packet Size=40' +
      '96;Workstation ID=DESARROLLO3;Use Encryption for Data=False;Tag ' +
