...
initialization
  { Application }
  InvRegistry.RegisterInterface(TypeInfo(IWSFinkokStamp), 'http://facturacion.finkok.com/stamp', 'UTF-8', '', 'Application');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(IWSFinkokStamp), '%operationName%');
  InvRegistry.RegisterInvokeOptions(TypeInfo(IWSFinkokStamp), ioDocument);
  { Application.stamp }
  InvRegistry.RegisterMethodInfo(TypeInfo(IWSFinkokStamp), 'stamp', '',
                                 '[ReturnName="stampResult"]', IS_OPTN or IS_NLBL);
  InvRegistry.RegisterParamInfo(TypeInfo(IWSFinkokStamp), 'stamp', 'xml', '',
                                '', IS_NLBL);
  InvRegistry.RegisterParamInfo(TypeInfo(IWSFinkokStamp), 'stamp', 'username', '',
                                '', IS_NLBL);
  ...
  InvRegistry.RegisterParamInfo(TypeInfo(IWSFinkokStamp), 'stamped', 'xml', '',
                                '', IS_NLBL);
  ...
  InvRegistry.RegisterMethodInfo(TypeInfo(IWSFinkokStamp), 'quick_stamp', '',
                                 '[ReturnName="quick_stampResult"]', IS_OPTN or IS_NLBL);
  InvRegistry.RegisterParamInfo(TypeInfo(IWSFinkokStamp), 'quick_stamp', 'xml', '',
                                '', IS_NLBL);
  InvRegistry.RegisterParamInfo(TypeInfo(IWSFinkokStamp), 'quick_stamp', 'username', '',
                                '', IS_NLBL);
  ...
  InvRegistry.RegisterMethodInfo(TypeInfo(IWSFinkokStamp), 'query_pending', '',
                                 '[ReturnName="query_pendingResult"]', IS_OPTN or IS_NLBL);
  InvRegistry.RegisterParamInfo(TypeInfo(IWSFinkokStamp), 'query_pending', 'username', '',
                                '', IS_NLBL);
